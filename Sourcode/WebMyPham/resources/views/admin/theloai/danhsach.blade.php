            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="modal-footer" style="float: left;">
                            <button type="button" class="btn btn-default" data-dismiss="modal"><a href="admin/theloai/them">Thêm Thể Loại</a></button>
                    </div>
                    
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                            <tr align="center">
                                <th class="text-center" width="200px">Thứ Tự Hiển Thị</th>
                                <th class="text-center">Tên Loại SP</th>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p>Nếu bạn XÓA Thể Loại này thì tất cả Sản Phẩm thuộc Thể Loại này cũng bị xóa. Bạn có chắc chắn muốn xóa Thể Loại: "{{$chitiet->name}}" không?</p>
                                                    </div>
