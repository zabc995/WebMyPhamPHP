                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                            <tr align="center">
                                ...
                                <th class="text-center">STT Hóa Đơn</th>
                        ...
                        <tbody>
                            @foreach($cthoadon as $chitiet)
                                <tr class="odd gradeX" align="center">
                                    <td>{{ $chitiet->id }}</td>
                                    <td>{{ $chitiet->id_bill }}</td>
                                    ...
                                    <td class="center"><i class="fa fa-pencil fa-fw"></i><a href="admin/chitiethoadon/sua/{{ $chitiet->id }}">Sửa</a></td>
                                    <td class="center">
