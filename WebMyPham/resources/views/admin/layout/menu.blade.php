<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-list fa-fw icon-mright"></i>Loại Sản Phẩm<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/theloai/danhsach">Danh Sách</a>
                                </li>
                                <li>
                                    <a href="admin/theloai/them">Thêm Loại Sản Phẩm</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-tasks fa-fw icon-mright"></i>Sản Phẩm<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="admin/customer/danhsach"><i class="fa fa-users fa-fw icon-mright"></i>Quản lý Khách Hàng</a>
                            
                            <!-- /.nav-second-level -->
                        </li>

                        <li>
                            <a href="admin/hoadon/danhsach"><i class="fa fa-newspaper-o fa-fw icon-mright"></i>Hóa Đơn</a>
