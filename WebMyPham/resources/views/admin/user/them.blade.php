                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="admin/user/them" method="POST">
                            ...
                            <div class="form-group">
                                <p><label>Họ Tên Người Dùng</label></p>
                                <input class="form-control input-width" type="text" name="username" placeholder="Nhập họ tên người dùng" value="{{ old('username') }}" />
                            </div>

                            <div class="form-group">
                                <p><label>SĐT</label></p>
                                <input class="form-control input-width" type="text" name="sdt" placeholder="Nhập SĐT người dùng" value="{{ old('username') }}" />
                            </div>

                            <div class="form-group">
                                <p><label>Địa Chỉ</label></p>
                                <input class="form-control input-width" type="text" name="address" placeholder="Nhập Địa Chỉ người dùng" value="{{ old('username') }}" />
                            </div>
