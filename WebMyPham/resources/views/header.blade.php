						...
						<div class="cart">
							...
							@if(Session::has('cart'))
								...
								<div class="cart-item">
									...
									<div class="media">
										<a class="pull-left" href="#"><img src="{{ URL::to('source/image/product/')}}/{{$product['item']['image']}}" alt=""></a>
								...
								<div class="cart-caption">
									<div class="cart-total text-right">Tổng tiền: <span class="cart-total-value">{{Session('cart')->totalPrice}} VNĐ</span></div>
									<div class="clearfix"></div>
